...
import senla.cources.HotelAdmin;
...
//создаем заказы : заселяем гостей и добавляем услуги в комнаты при помощи методов
        Booking booking1 = new Booking(room1, LocalDate.of(2022, Month.JANUARY, 07), LocalDate.of(2022, Month.JANUARY, 31));
        ...
        Booking booking2 = new Booking(room2, LocalDate.of(2022, Month.JANUARY, 05), LocalDate.of(2022, Month.JANUARY, 31));
        ...
        Booking booking3 = new Booking(room3, LocalDate.of(2022, Month.JANUARY, 05), LocalDate.of(2022, Month.JANUARY, 31));
...
//Создаем базу заказов
        ...
        System.out.println(bookingService.isGuestCurrent(guest2));
